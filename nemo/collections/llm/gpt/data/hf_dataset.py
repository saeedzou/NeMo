...
class HFDatasetDataModule(pl.LightningDataModule):
    ...
    def pack(self, split_across_pack=False, max_packs=None):
        """
        Calls pack() method from HFDatasetPackedSequence class that implements packing.
        Args:
        ...
        max_packs (Optional[int]): Maximum number of packs. Default is None, which will create as many
            packs as possible.
        """
        packed_datamodule = HFDatasetPackedSequence(self.dataset_splits)
        packed_datamodule.pack(self.packed_sequence_size, split_across_pack, max_packs)
